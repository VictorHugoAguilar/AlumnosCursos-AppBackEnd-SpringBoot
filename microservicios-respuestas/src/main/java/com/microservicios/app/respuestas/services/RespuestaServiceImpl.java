...
//		List<Long> preguntaId = preguntas.stream().map(pregunta -> pregunta.getId()).collect(Collectors.toList());
...
//			examenIds = examenClient.obtenerExamenesIdPorPreguntasIdRespondidas(preguntaIds);
//		}
